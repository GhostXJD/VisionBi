                    ...
                    {isAuthenticated ? (
                        <>
                            ...
                            <div className='ml-auto'>
                                ...
                                >
                                    <MenuItem onClick={() => { handleMenuClose(); }} > <button className={`text-center px-3 py-1 h-8 bg-[#8F3C8A] rounded-3xl hover:bg-[#4b1c71]  dark:bg-[#8F3C8A] dark:hover:bg-[#b57edc]`}
                                        onClick={toggleTheme}>
                            ...
                            <button className={`text-center px-3 py-1 h-8 bg-[#8F3C8A] rounded-3xl hover:bg-[#4b1c71]  dark:bg-[#8F3C8A] dark:hover:bg-[#b57edc]`}
                                onClick={toggleTheme}>
                                <div className="flex items-center space-x-2 ">
                                    <div>
                                        <svg
